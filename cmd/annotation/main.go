...
func main() {
	...
	e.GET("/ws", annotationHandler.HandleAnnotation)
	e.GET("/ws/remain-count", remainCountHandler.HandleRemainImageCount)
	e.GET("/ws/predict-remain-count", predictedRemainImageCountHandler.HandlePredictedRemainImageCount)
	e.GET("/ws/check", annotatedDataCheckHandler.HandleAnnotatedDataCheck)
	e.GET("/ws/ai", predictedDataHandler.HandlePredictedData)
