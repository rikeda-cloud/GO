...
func main() {
	...
	e.GET("/ws/predict-remain-count", predictedRemainImageCountHandler.RemainImageCountHandler.RemainImageCountHandler)
	e.GET("/ws/check", annotatedDataCheckHandler.AnnotatedDataCheckHandler)
	e.GET("/ws/ai", predictedDataHandler.ImageClickHandler.ImageClickHandler)
